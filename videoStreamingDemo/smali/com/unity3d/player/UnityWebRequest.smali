...
.method public run()V
    ...
    :cond_1
    instance-of v2, v3, Ljava/net/JarURLConnection;

    if-eqz v2, :cond_2

    const-string v2, "A URL Connection to a Java ARchive (JAR) file or an entry in a JAR file is not supported"
    ...
    invoke-virtual {p0, v2}, Lcom/unity3d/player/UnityWebRequest;->sslCannotConnectCallback(Ljava/lang/String;)V
